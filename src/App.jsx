...
import { Sun, Moon, Compass, Sparkles, FolderOpen, ArrowRight, Shield, Globe, Award, Activity, Heart, Info, LayoutGrid, List } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#080B10] text-slate-805 dark:text-slate-100 font-sans flex flex-col scroll-smooth transition-colors duration-500">
      
      {/* ── HOME PAGE VIEW ── */}
      {!hasSearched && (
        <>
          {/* HEADER */}
          <header className="sticky top-0 z-30 transition-all duration-300 backdrop-blur-md bg-white/75 dark:bg-[#080B10]/75 border-b border-slate-200/40 dark:border-slate-800/60 py-4.5 px-4 sm:px-6">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              {/* Logo */}
              <div className="flex flex-col cursor-pointer group" onClick={clearSearch}>
                <div className="flex items-center gap-1.5 leading-none">
                  <span className="text-2xl font-black text-teal-600 tracking-tight group-hover:scale-105 transition-transform">360°</span>
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <button
                  ...
                  className="p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-650 dark:text-slate-455 hover:bg-slate-50 dark:hover:bg-slate-900/60 hover:text-slate-900 dark:hover:text-white transition-all cursor-pointer shadow-sm hover:scale-105"
                  aria-label="Toggle Dark Mode"
                >
                  {darkMode ? <Sun size={17} className="text-teal-500" /> : <Moon size={17} className="text-slate-700" />}
                </button>
          ...
          <main className="flex-1 flex flex-col items-center justify-center relative bg-[#F8FAFC] dark:bg-[#080B10] overflow-hidden min-h-[calc(100vh-85px)] transition-colors duration-500">
            ...
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[90%] sm:w-[60%] h-[35%] bg-gradient-to-r from-teal-500/10 via-indigo-500/5 to-purple-600/5 dark:from-teal-500/5 dark:via-indigo-900/5 dark:to-teal-550/5 rounded-full blur-3xl pointer-events-none"></div>
            
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 w-full text-center pb-24 pt-12 sm:pt-16">
              
              {/* Introduction Badge */}
              <div className="inline-flex items-center gap-2 mb-7 px-4.5 py-2 rounded-full border border-teal-500/20 dark:border-teal-500/30 bg-gradient-to-r from-teal-500/10 via-indigo-500/5 to-teal-500/10 text-teal-600 dark:text-teal-400 text-[10px] sm:text-xs font-black tracking-widest uppercase animate-fade-in shadow-[0_4px_20px_rgba(13,148,136,0.08)]">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6.5xl font-playfair font-black text-slate-900 dark:text-white tracking-tight mb-6 leading-tight animate-fade-in" style={{ animationDelay: '100ms', animationFillMode: 'both' }}>
                ...
                <span className="italic text-transparent bg-clip-text bg-gradient-to-r from-teal-600 via-teal-500 to-indigo-600 dark:from-teal-400 dark:via-teal-300 dark:to-indigo-400">
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-3">
                  {[
                    ...
                    <button 
                      ...
                      className="bg-white dark:bg-[#0e131f]/80 hover:bg-slate-50 dark:hover:bg-[#161d2f] border border-slate-200/80 dark:border-slate-800 text-slate-655 dark:text-slate-300 text-xs sm:text-sm px-4.5 py-3 rounded-full transition-all hover:border-teal-500/40 dark:hover:border-teal-500/40 hover:text-teal-600 dark:hover:text-teal-400 hover:-translate-y-0.5 cursor-pointer shadow-sm"
                    >
                      "{chip}"
                    </button>
                  ))}
              ...
              <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-5xl mx-auto w-full animate-fade-in" style={{ animationDelay: '400ms', animationFillMode: 'both' }}>
                ...
                <div className="md:col-span-2 relative aspect-[16/10] sm:aspect-video rounded-3xl overflow-hidden shadow-lg border border-slate-200/50 dark:border-slate-800/80 group bg-slate-900">
                  <img 
                  ...
                  <div className="absolute top-5 left-5 bg-teal-600 text-white text-[10px] font-extrabold px-3 py-1.5 rounded-full shadow-md shadow-teal-650/10 tracking-widest uppercase flex items-center gap-1.5">
                  ...
                  <div className="absolute bottom-6 left-6 text-white z-10">
                    ...
                    <p className="text-slate-355 text-xs sm:text-sm mt-1 font-semibold">Explore verified floor layouts in Gurgaon, Sector 54</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="relative aspect-[16/10] md:flex-1 rounded-3xl overflow-hidden shadow-md border border-slate-200/50 dark:border-slate-800/80 group bg-slate-900">
                    <img 
                  ...
                  <div className="bg-white dark:bg-[#0e131f] border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-7 shadow-md flex flex-col justify-between md:flex-1 min-h-[180px] relative overflow-hidden transition-colors duration-300">
                    {/* Glowing orb inside card */}
                    <div className="absolute -right-16 -bottom-16 w-32 h-32 bg-teal-500/10 dark:bg-teal-500/5 rounded-full blur-2xl pointer-events-none" />
                    
                    <div>
                      <div className="bg-teal-500/10 text-teal-600 p-3 rounded-2xl w-fit mb-4">
                    ...
                    <a href="#matching" className="text-xs font-black text-teal-600 hover:text-teal-700 dark:hover:text-teal-400 flex items-center gap-1.5 mt-5">
          ...
          {/* LANDING FOOTER */}
          <footer className="border-t border-slate-200/60 dark:border-slate-800/80 py-10 bg-[#F1F5F9] dark:bg-[#0b0f19] transition-colors duration-500">
            <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-6 text-center sm:text-left">
              <div className="flex flex-col">
                <div className="flex items-center justify-center sm:justify-start gap-1 leading-none">
                  <span className="text-lg font-black text-teal-600 tracking-tight">360°</span>
              ...
              <div className="flex flex-wrap justify-center gap-6 text-xs text-slate-500 font-bold">
                <a href="#privacy" className="hover:text-teal-600 dark:hover:text-white transition-colors">Privacy Policy</a>
                <a href="#terms" className="hover:text-teal-600 dark:hover:text-white transition-colors">Terms of Service</a>
                <a href="#ethics" className="hover:text-teal-600 dark:hover:text-white transition-colors">AI Ethics Code</a>
                <a href="#contact" className="hover:text-teal-600 dark:hover:text-white transition-colors">Contact Expert</a>
              </div>
            </div>
          </footer>
        </>
      ...
      {hasSearched && (
        <div className="flex-1 flex bg-[#F8FAFC] dark:bg-[#080B10] transition-colors duration-500">
          
          {/* SLEEK LEFT SIDEBAR */}
          <aside className="hidden md:flex flex-col w-[250px] bg-[#F1F5F9] dark:bg-[#0e131f] border-r border-slate-200/50 dark:border-slate-800/60 p-6 shrink-0 justify-between">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-3.5 px-4.5 py-3.5 rounded-2xl text-xs sm:text-sm font-black transition-all duration-300 cursor-pointer
                        ${isActive 
                          ? 'bg-gradient-to-r from-teal-600 to-indigo-600 text-white shadow-md shadow-teal-500/10' 
            ...
            <div className="bg-white/60 dark:bg-[#0e131f]/60 border border-slate-200/40 dark:border-slate-800 p-4.5 rounded-2xl shadow-sm text-center">
          ...
          <div className="flex-1 flex flex-col bg-slate-50/50 dark:bg-[#0b0f19]/30 min-h-screen">
            
            {/* FLOATING TOP BAR */}
            <header className="sticky top-0 z-20 bg-white/85 dark:bg-[#080B10]/85 backdrop-blur-md border-b border-slate-200/40 dark:border-slate-800/60 py-3.5 px-4 sm:px-6 flex items-center justify-between shadow-sm">
              ...
              <div className="flex items-center gap-3 sm:gap-4 ml-4 flex-shrink-0">
                <button
                  onClick={() => setDarkMode(!darkMode)}
                  className="p-2.5 rounded-xl border border-slate-200/50 dark:border-slate-800 text-slate-655 dark:text-slate-455 hover:bg-slate-50 dark:hover:bg-slate-900/60 hover:text-slate-900 dark:hover:text-white transition-all cursor-pointer shadow-sm hover:scale-105"
                  aria-label="Toggle Dark Mode"
                >
                  {darkMode ? <Sun size={17} className="text-teal-500" /> : <Moon size={17} className="text-slate-700" />}
                </button>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 flex-1 w-full">
              ...
              {followUpQuestion && (
                <div className="mb-8 p-5 rounded-2xl bg-teal-500/5 dark:bg-teal-500/10 border border-teal-500/15 text-xs sm:text-sm animate-fade-in flex flex-col sm:flex-row sm:items-center justify-between gap-4.5 shadow-sm">
                  <div className="flex items-start sm:items-center gap-2.5 text-slate-800 dark:text-slate-200">
                    <Sparkles className="w-5 h-5 text-teal-550 flex-shrink-0 animate-pulse mt-0.5 sm:mt-0" />
                  ...
                  <div className="flex gap-2.5 flex-shrink-0">
                    {followUpQuestion.options.map((option, idx) => (
                      <button
                        ...
                        className="bg-white dark:bg-[#0e131f] hover:bg-teal-500/5 dark:hover:bg-teal-950/20 border border-teal-500/25 text-teal-650 dark:text-teal-400 font-extrabold px-4.5 py-2.5 rounded-xl text-xs transition-all cursor-pointer shadow-sm active:scale-97 hover:scale-102"
                      >
                        {option.label}
                      </button>
                    ))}
              ...
              {/* Layout Switcher & BHK Filters Bar */}
              <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-[#0e131f] border border-slate-200/60 dark:border-slate-800/80 p-4 rounded-3xl shadow-sm">
                
                {/* BHK Quick Filters */}
                <div className="flex flex-wrap items-center gap-1.5">
                  <span className="text-[10px] uppercase font-bold tracking-widest text-slate-400 dark:text-slate-505 mr-2">Quick Layouts:</span>
                  {[
                    ...
                    <button
                      key={tab.value}
                      onClick={() => setBhkFilter(tab.value)}
                      className={`px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer active:scale-95
                        ${bhkFilter === tab.value
                          ? "bg-teal-500 text-white shadow-md shadow-teal-500/20"
                          : "bg-slate-50 dark:bg-slate-900/60 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-250/20 dark:border-slate-800/40"
                        }`}
                    >
                      {tab.label}
                    </button>
                ...
                <div className="flex items-center gap-1.5 self-end sm:self-auto">
                  <span className="text-[10px] uppercase font-bold tracking-widest text-slate-400 dark:text-slate-505 mr-2">View Mode:</span>
                  <div className="bg-slate-50 dark:bg-slate-900/60 p-1 rounded-2xl border border-slate-250/20 dark:border-slate-800/40 flex items-center">
                    <button
                      onClick={() => setLayoutMode("grid")}
                      className={`px-4.5 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5
                        ${layoutMode === "grid"
                          ? "bg-white dark:bg-[#0e131f] text-teal-600 dark:text-teal-400 shadow-sm border border-slate-200/50 dark:border-slate-800/40"
              ...
              <PropertyGrid 
                properties={bhkFilter === "all" ? filteredProperties : filteredProperties.filter(p => p.bhk === parseInt(bhkFilter))} 
            ...
            {/* RESULTS FOOTER */}
            <footer className="mt-auto border-t border-slate-200/50 dark:border-slate-800/60 py-7 bg-[#F1F5F9] dark:bg-[#0b0f19]/30 text-xs text-slate-500">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-4.5">
                ...
                <div className="flex gap-6 font-bold">
                  <a href="#privacy" className="hover:text-teal-600 dark:hover:text-white transition-colors">Privacy</a>
                  <a href="#terms" className="hover:text-teal-600 dark:hover:text-white transition-colors">Terms</a>
                  <a href="#ethics" className="hover:text-teal-600 dark:hover:text-white transition-colors">AI Ethics</a>
                  <a href="#contact" className="hover:text-teal-600 dark:hover:text-white transition-colors">Support</a>
                </div>
              </div>
            </footer>
          </div>
      ...
      {compareList.length === 2 && (
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-slate-900/95 dark:bg-[#0b0f19]/95 text-white px-6 py-4.5 flex flex-col sm:flex-row items-center justify-between shadow-2xl border-t border-slate-800/80 backdrop-blur-md animate-[modalScale_0.3s_ease-out_forwards]">
          <div className="flex items-center gap-4 mb-4 sm:mb-0">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Compare Portal:</span>
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-teal-400 text-sm">{compareList[0].title}</span>
              <span className="text-slate-505 text-xs uppercase font-bold">vs</span>
              <span className="font-extrabold text-teal-400 text-sm">{compareList[1].title}</span>
            </div>
          </div>
          <div className="flex gap-5 items-center w-full sm:w-auto justify-end">
            ...
            <button 
              ...
              className="bg-gradient-to-r from-teal-650 to-indigo-600 hover:from-teal-700 hover:to-indigo-700 px-6.5 py-3 rounded-xl text-xs sm:text-sm font-black shadow-lg shadow-teal-500/20 hover:shadow-teal-500/40 transition-all active:scale-95 cursor-pointer"
            >
